...
//	var days = new Array("日", "一", "二", "三", "四", "五", "六");
	var date = new Date();
//	var year = date.getFullYear(); // 返回date对象中的四位数年份
//	var month = date.getMonth() + 1; // 返回date对象中的月份数(1-12)
//	var day = date.getDate(); // 返回date对象中的月份中的天数(1-31)
//	var weekday = date.getDay(); // 返回date对象中的星期中的天数(0-6)
	var hour = date.getHours(); // 返回date对象中的小时数(0-23)
	var minute = date.getMinutes(); // 返回date对象中的分钟数(0-59)
	if (minute < 10)
		minute = "0" + minute;
	var second = date.getSeconds(); // 返回date对象中的秒数(0-59)
	if (second < 10)
		second = "0" + second;
//	str = year + "年" + month + "月" + day + "日 星期" + days[weekday] + " " + hour
//			+ ":" + minute + ":" + second;
	str = hour + ":" + minute + ":" + second;
	document.getElementById("mytime").innerHTML = str;
}
function updateTime() {
	window.setInterval("getTimes()", 200);
}
